...
cv2.setTrackbarPos('rx', 'TrackBar', 175,)
cv2.setTrackbarPos('ry', 'TrackBar', 0,)
cv2.setTrackbarPos('rz', 'TrackBar', 25,)
cv2.setTrackbarPos('tx', 'TrackBar', 0,)
cv2.setTrackbarPos('ty', 'TrackBar', 0,)
cv2.setTrackbarPos('tz', 'TrackBar', 0,)
